...
namespace DealerDAL.DAL
{
    ...
    public partial class Log
    {
        ...
        /// </summary>
        public static int Create(LogDO DO)
        {
            return Create(null); 
        }
        ...
        /// Creates a new Log record
        /// </summary>
        public static int Create(LogDO DO, DalapiTransaction Transaction)
        {
        ...
        /// </summary>
        public static int Update(LogDO DO)
        {
        ...
        /// Updates a Log record and returns the number of records affected
        /// </summary>
        public static int Update(LogDO DO, DalapiTransaction Transaction)
        {
        ...
        /// </summary>
        public static int Delete(LogDO DO)
        {
        ...
        /// Deletes a Log record
        /// </summary>
        public static int Delete(LogDO DO, DalapiTransaction Transaction)
        {
            SqlParameter _Id = new SqlParameter("Id", SqlDbType.Int);
        ...
        /// </summary>
        public static LogDO[] GetByPK(Int32 Id)
        {
